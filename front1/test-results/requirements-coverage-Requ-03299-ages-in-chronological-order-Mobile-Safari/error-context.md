...
- main:
  ...
  - log "Chat message history":
    - list "4 messages":
      - listitem "user message from 12:25 PM": First message 12:25 PM
      - listitem "assistant message from 12:25 PM": "Local response to: First message 12:25 PM(local)"
      - listitem "user message from 12:25 PM": Second message 12:25 PM
      - listitem "assistant message from 12:25 PM": "Local response to: Second message 12:25 PM(local)"
