...
- main:
  ...
  - log "Chat message history":
    - list "4 messages":
      - listitem "user message from 12:20 PM": Tablet local test 12:20 PM
      - listitem "assistant message from 12:20 PM": "Response to: Tablet local test 12:20 PM(local)"
      - listitem "user message from 12:20 PM": Tablet remote test 12:20 PM
