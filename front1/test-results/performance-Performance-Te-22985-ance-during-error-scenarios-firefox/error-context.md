...
- main:
  ...
  - log "Chat message history":
    - list "4 messages":
      - listitem "user message from 12:19 PM": Error test message 1 12:19 PM
      - listitem "assistant message from 12:19 PM": "Success response to: Error test message 1 12:19 PM(local)"
      - listitem "user message from 12:19 PM": Error test message 2 12:19 PM
      - listitem "assistant message from 12:19 PM": "Success response to: Error test message 2 12:19 PM(local)"
