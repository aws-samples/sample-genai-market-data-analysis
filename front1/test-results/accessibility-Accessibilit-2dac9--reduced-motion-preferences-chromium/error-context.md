...
- main:
  ...
  - log "Chat message history":
    - list "2 messages":
      - listitem "user message from 12:16 PM": Reduced motion test 12:16 PM
      - listitem "assistant message from 12:16 PM": "Response to: Reduced motion test 12:16 PM(local)"
