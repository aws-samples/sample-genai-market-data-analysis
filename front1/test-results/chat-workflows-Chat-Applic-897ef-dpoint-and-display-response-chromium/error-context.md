...
- main:
  ...
  - log "Chat message history":
    - list "2 messages":
      - listitem "user message from 12:17 PM": Hello local endpoint 12:17 PM
      - listitem "assistant message from 12:17 PM": "Local response to: Hello local endpoint 12:17 PM(local)"
