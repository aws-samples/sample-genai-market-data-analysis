...
- main:
  ...
  - log "Chat message history":
    - list "4 messages":
      - listitem "user message from 12:24 PM": Tablet local test 12:24 PM
      - listitem "assistant message from 12:24 PM": "Response to: Tablet local test 12:24 PM(local)"
      - listitem "user message from 12:24 PM": Tablet remote test 12:24 PM
