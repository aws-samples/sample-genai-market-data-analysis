...
- main:
  ...
  - log "Chat message history":
    - list "2 messages":
      - listitem "user message from 12:24 PM": Tablet test message 12:24 PM
      - listitem "assistant message from 12:24 PM": "Response to: Tablet test message 12:24 PM(local)"
