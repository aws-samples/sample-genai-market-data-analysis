...
- main:
  ...
  - log "Chat message history":
    - list "2 messages":
      - listitem "user message from 12:24 PM": Test error clear 12:24 PM
      - listitem "error message from 12:25 PM": local service is temporarily unavailable (Error 500). Please try again later. 12:25 PM
