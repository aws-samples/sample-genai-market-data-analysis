...
- main:
  ...
  - log "Chat message history":
    - list "4 messages":
      - listitem "user message from 12:22 PM": First message 12:22 PM
      - listitem "assistant message from 12:22 PM": "Local response to: First message 12:22 PM(local)"
      - listitem "user message from 12:22 PM": Second message 12:22 PM
