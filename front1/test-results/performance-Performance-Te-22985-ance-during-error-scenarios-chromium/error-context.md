...
- main:
  ...
  - log "Chat message history":
    - list "4 messages":
      - listitem "user message from 12:17 PM": Error test message 1 12:17 PM
      - listitem "assistant message from 12:17 PM": "Success response to: Error test message 1 12:17 PM(local)"
      - listitem "user message from 12:17 PM": Error test message 2 12:17 PM
      - listitem "assistant message from 12:17 PM": "Success response to: Error test message 2 12:17 PM(local)"
