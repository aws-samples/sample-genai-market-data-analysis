...
- main:
  ...
  - log "Chat message history":
    - list "4 messages":
      - listitem "user message from 12:21 PM": First message 12:21 PM
      - listitem "assistant message from 12:21 PM": "Local response to: First message 12:21 PM(local)"
      - listitem "user message from 12:21 PM": Second message 12:21 PM
      - listitem "error message from 12:21 PM": "Configuration error: Remote endpoint not configured 12:21 PM"
