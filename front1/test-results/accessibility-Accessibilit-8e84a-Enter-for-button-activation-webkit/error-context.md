...
- main:
  ...
  - log "Chat message history":
    - list "4 messages":
      - listitem "user message from 12:20 PM": Space key test 12:20 PM
      - listitem "assistant message from 12:20 PM": "Response to: Space key test 12:20 PM(local)"
      - listitem "user message from 12:20 PM": Enter button test 12:20 PM
      - listitem "assistant message from 12:20 PM": "Response to: Enter button test 12:20 PM(local)"
