...
- main:
  ...
  - log "Chat message history":
    - list "2 messages":
      - listitem "user message from 12:20 PM": Tablet test message 12:20 PM
      - listitem "assistant message from 12:20 PM": "Response to: Tablet test message 12:20 PM(local)"
