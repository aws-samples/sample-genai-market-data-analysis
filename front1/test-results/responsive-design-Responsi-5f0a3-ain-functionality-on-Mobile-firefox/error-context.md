...
- main:
  ...
  - log "Chat message history":
    - list "4 messages":
      - listitem "user message from 12:20 PM": Mobile local test 12:20 PM
      - listitem "assistant message from 12:20 PM": "Response to: Mobile local test 12:20 PM(local)"
      - listitem "user message from 12:20 PM": Mobile remote test 12:20 PM
