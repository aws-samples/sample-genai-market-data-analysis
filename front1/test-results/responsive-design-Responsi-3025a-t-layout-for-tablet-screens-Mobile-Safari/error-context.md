...
- main:
  ...
  - log "Chat message history":
    - list "2 messages":
      - listitem "user message from 12:25 PM": Tablet test message 12:25 PM
      - listitem "assistant message from 12:25 PM": "Response to: Tablet test message 12:25 PM(local)"
