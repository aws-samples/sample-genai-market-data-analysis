...
- main:
  ...
  - log "Chat message history":
    - list "4 messages":
      - listitem "user message from 12:24 PM": Desktop local test 12:24 PM
      - listitem "assistant message from 12:24 PM": "Response to: Desktop local test 12:24 PM(local)"
      - listitem "user message from 12:24 PM": Desktop remote test 12:24 PM
