...
- main:
  ...
  - log "Chat message history":
    - list "2 messages":
      - listitem "user message from 12:22 PM": Hello local endpoint 12:22 PM
      - listitem "assistant message from 12:22 PM": "Local response to: Hello local endpoint 12:22 PM(local)"
