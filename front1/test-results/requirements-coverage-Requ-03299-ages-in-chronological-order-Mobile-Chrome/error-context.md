...
- main:
  ...
  - log "Chat message history":
    - list "4 messages":
      - listitem "user message from 12:23 PM": First message 12:23 PM
      - listitem "assistant message from 12:23 PM": "Local response to: First message 12:23 PM(local)"
      - listitem "user message from 12:23 PM": Second message 12:23 PM
      - listitem "assistant message from 12:23 PM": "Local response to: Second message 12:23 PM(local)"
