...
- main:
  ...
  - log "Chat message history":
    - list "2 messages":
      - listitem "user message from 12:24 PM": Test dismiss error 12:24 PM
      - listitem "error message from 12:24 PM": local service is temporarily unavailable (Error 500). Please try again later. 12:24 PM
