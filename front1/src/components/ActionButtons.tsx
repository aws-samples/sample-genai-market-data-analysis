    ...
    <>
      ...
      <div className="mt-3 pt-3 border-t border-slate-200">
        <div className="grid grid-cols-3 gap-4 text-xs text-slate-500">
          <div id="send-local-help" className="flex items-start space-x-2">
            <div className="w-2 h-2 bg-blue-500 rounded-full mt-1.5 flex-shrink-0"></div>
            <div>
              <div className="font-medium text-slate-700">Local Analysis</div>
              <div>On-premise research engine for sensitive data</div>
            </div>
          </div>
          <div id="send-remote-help" className="flex items-start space-x-2">
            <div className="w-2 h-2 bg-green-500 rounded-full mt-1.5 flex-shrink-0"></div>
            <div>
              <div className="font-medium text-slate-700">Cloud Research</div>
              <div>Advanced AI models with real-time market data</div>
            </div>
          </div>
          <div id="clear-chat-help" className="flex items-start space-x-2">
            <div className="w-2 h-2 bg-slate-400 rounded-full mt-1.5 flex-shrink-0"></div>
            <div>
              <div className="font-medium text-slate-700">Clear Session</div>
              <div>Remove all messages and start fresh</div>
            </div>
          </div>
        </div>
      </div>
