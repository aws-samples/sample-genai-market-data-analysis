...
Claude37 = BedrockModel(model_id="us.anthropic.claude-3-7-sonnet-20250219-v1:0")
Llama4 = BedrockModel(model_id="us.meta.llama4-maverick-17b-instruct-v1:0")
NovaPremier = BedrockModel(model_id="us.amazon.nova-premier-v1:0")
Claude4 = BedrockModel(model_id="us.anthropic.claude-sonnet-4-20250514-v1:0")

financial_analyst_agent = Agent(
    name="financialAnalyst",
    model=Claude37,
    tools=[calculator, stock_performance_returns, get_news_for_stock, get_technical_analysis_for_stock, get_financial_info_for_stock, stock_performance_returns],
...
final_response_agent = Agent(
    ...
    system_prompt="""You are an experience HTML coder, make sure all text is properly formatted. 
                     ...
                     add spaces or separator, boxes or other constructs to make the information visually pleasant
                     """
)